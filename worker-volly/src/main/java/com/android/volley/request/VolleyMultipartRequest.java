...
/**
 * Custom request to make multipart header and upload file. Sketch Project
 * Studio Created by Angga on 27/04/2016 12.05.
 */
public class VolleyMultipartRequest extends Request<NetworkResponse> {
    ...
    private void buildDataPart(DataOutputStream dataOutputStream, DataPart dataFile,
        ...
        dataOutputStream.writeBytes("Content-Disposition: form-data; name=\"" + inputName
                + "\"; filename=\"" + dataFile.getFileName() + "\"" + lineEnd);
