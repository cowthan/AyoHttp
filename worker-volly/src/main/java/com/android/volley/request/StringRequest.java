...
public class StringRequest extends Request<String> {
    ...
    public StringRequest(int method, String url, Listener<String> listener,
            OnCacheListener<String>  onCacheListener, ErrorListener errorListener) {
        super(method, url, errorListener);
        mListener = listener;
        this.cacheListener = onCacheListener;
    }

    public StringRequest(String url, Listener<String> listener, OnCacheListener<String> onCacheListener,
            ErrorListener errorListener) {
        this(Method.GET, url, listener, errorListener);
        this.cacheListener = onCacheListener;
    }
    ...
    public StringRequest(int method, String url, Listener<String> listener,
                         OnCacheListener<String>  onCacheListener,OnNotModifyListener onNotModifyListener, ErrorListener errorListener) {
        super(method, url, errorListener);
        mListener = listener;
        this.cacheListener = onCacheListener;
