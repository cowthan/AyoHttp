 ...
 * Fragment is created, then use {@link #get(String, ImageView)} or one of
...
public class SimpleImageLoader extends ImageLoader {
    ...
    /**
     * Sets a {@link Bitmap} to an {@link ImageView} using a
     * fade-in animation. If there is a {@link Drawable} already set on
